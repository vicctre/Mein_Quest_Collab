...
var sclae = 2
draw_text_ext_transformed_color(scr_camx_cent(0), scr_camy(0) + yy, text, 0, 10000, sclae, sclae, 0,
								c, c, c, c, 1)
if goto_next_room_on {
	...
	draw_text_color(scr_camx_cent(0), scr_camy(0) + yy + 120, text, c, c, c, c, 1)
}
